      ...
      <div id="tablephp">
        <?php
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td style='text-align:center'><a href=../pdf/".$fila["pdfInicioS"]."><img src='../images/ver.png' width='100%'></a></td>
                  <td> <a href='actualizarSesion.php?id=".$fila['idIniciosesion']."'> <input  class='btn   btn-sm' style='color: green; font-size: 18px' type='button' value=' Actualizar'></a></td>
