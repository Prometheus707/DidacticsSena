        ...
        <div class="w3-row w3-padding ">
          ...
          <div class="w3-col l6 w3-white subirn2">
            ...
            <div class="w3-white ">
              ...
              <p style='color: #f2740b'> Cargue nuevamente el archivo de técnica didáctica activa <?php echo $fila['rutaPDF']; ?> </p><input type="file" style="width: 80%;" class="form-control" name="archivo" value="<?php echo $fila['descripcionTda']; ?>" id="archivoInput" onchange="return validarExt()" >
              <br>
