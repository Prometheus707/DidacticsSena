      ...
      <div id="tablephp">
        <?php
                ...
                echo "<table border='1'  class=' table-bordered table-hover'>
                  ...
                  <th class='t2' >Documento</b></th>
                  <th class='t2' >Nombre</b></th>
                  <th class='t2'>Apellido</b></th>
                  <th class='t2'>Teléfono</b></th>
                  <th  class='t2'>Correo</b></th>
                  <th class='t2'>Estado</b></th>
                  <th  class='t2'>Rol</b></th>
                  <th  class='t2'>Permiso</b></th>
                  <th class='t2'>Actualizar</b></th>
                  <th class='t2'>Eliminar</b></th>
              ...
              where
              docUsuario like '%$busqueda%' OR
              apellidoUsuario like '%$busqueda%' OR
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  echo "<td class='t22' style='padding-bottom:4%;padding-top:4%'>".$fila['docUsuario']."</td>";
                  echo "<td class='t33'>".$fila['nombreUsuario']."</td>";
                  echo "<td class='t44'>".$fila['apellidoUsuario']."</td>
                        <td class='t55'>".$fila['telefonoUsuario']."</td>
                        <td class='t66'>".$fila['correoUsuario']."</td> ";
              
                        if( $fila['nombreEstado'] == 'Activo' ) {
                     
                          echo "<td > <center> <button class='btn btn-success ' style='cursor: default; text.aling:center;' >".$fila['nombreEstado']." </center></button></td>";
                          ...
                          if( $fila['nombreEstado'] == 'Inactivo' ) {
                            ...
                            echo "<td ><center> <button class='btn btn-danger ' style='cursor: default; text.aling:center;' >".$fila['nombreEstado']." </center></button></td>";
                        ...
                        <td class='t12'> <a href='permiso.php?id=".$fila["docUsuario"]."'> <input  class='btn tdasbtn' style='color: green;'  type='button' value=' Permiso'></a></td>
                        <td class='t12'> <a href='actualizarInstruc.php?id=".$fila["docUsuario"]."'> <input style='color: green;' class='btn tdasbtn'  type='button' value=' Actualizar'></a></td>
                        <td class='t12'> <a href='eliminarUsu.php?id=".$fila["docUsuario"]."'>  <button type='button' style='color: red;' class='btn tdasbtn'  onclick='return ConfirmDelet()'> eliminar </button> </a></td>
