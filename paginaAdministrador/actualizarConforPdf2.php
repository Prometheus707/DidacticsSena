...
// este es el codigo de guardar diferentes tipos de archivos //
		...
		if ( in_array($ext, $formatos)){
			if ( move_uploaded_file ( $nombreTmpArchivo , "../pdf/$nombreArchivo" )) {
				header('location: tdaEquipo.php?opcion8=true');
			} else{
...
$sql = "UPDATE conformargpdf SET nombreConforPdf='$nombre',descripcionCoPdf='$descripcion',pdfConfor='$nombreArchivo'  WHERE idConforPdf=".$id;
