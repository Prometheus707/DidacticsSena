      ...
      <div id="tablephp">
        <?php
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td> <a href='actualizarApropia.php?id=".$fila['idTda']."'> <input  class='btn   btn-sm' style='color: green; font-size: 18px' type='button' value=' Actualizar'></a></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <input type="text" class="form-control" style="width: 80%;margin-left: 4%" name="descripcion" value="" required>
