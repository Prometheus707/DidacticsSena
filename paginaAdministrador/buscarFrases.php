      ...
      <div id="tablephp">
        <?php
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td style='text-align:center'><a href=../pdf/".$fila["pdfFrases"]."><img src='../images/ver.png' width='100%'></a></td>
                  <td> <a href='actualizarFrases.php?id=".$fila['idFrases']."'> <input  class='btn   btn-sm' style='color: green; font-size: 18px' type='button' value=' Actualizar'></a></td>
