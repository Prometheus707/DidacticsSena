...
$count="SELECT COUNT(*) FROM rompehielos";
 ...
 mysqli_set_charset($conecta,"utf8");
  ...
  while($rows = $c->fetch_assoc())
  {
    if($id == $rows['idRompeH']) {
    echo "<tr>";
    echo "<td>".$rows['tituloRompeH']."<button  class='btn btn-success content' style='cursor: default; float:right; margin-top:7vh;   background:green; width:40%; color:white;   '> Nuevo </button></td>";
