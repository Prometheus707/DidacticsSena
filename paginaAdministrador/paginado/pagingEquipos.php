...
$count="SELECT COUNT(*) FROM conformarg";
 ...
 mysqli_set_charset($conecta,"utf8");
  ...
  while($rows = $c->fetch_assoc())
  {
    ...
    echo "<tr>";
    echo "<td>".$rows['tituloConfor']."<button  class='btn btn-success content' style='cursor: default; float:right; margin-top:7vh;   background:green; width:40%; color:white;   '> Nuevo </button></td>";
