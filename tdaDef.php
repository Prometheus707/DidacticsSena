...
<button id="btnEnviar" class="btn btn-outline-success text-dark"  style="max-width:100%; min-width:13vh; height:75%; margin-top:0.7%"  type="button" value="Buscar" onClick="resaltarTexto();" > Buscar</button>
...
<style>
    ...
    <div class="w3-col l4">
      ...
      <!-- Subscribe -->
      <div class="w3-white w3-margin ">
        <div style="width:108%; margin-left:-4%; " class="w3-container w3-padding color">
        <h4>Reflexión</h4>
        </div>
        <div class="w3-container w3-white">
