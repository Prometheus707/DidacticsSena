...
*/
			$consulta = "SELECT * FROM usuario where docUsuario= '".$cedula."'";
		  	...
		  	$resultado = $conecta->query($consulta);
		  		...
		  		{
						$consulta = "INSERT INTO usuario (idUsuario,idRol,idArea,idCentro,idRegional,docUsuario,nombreUsuario,apellidoUsuario,telefonoUsuario,correoUsuario,claveUsuario,estado)
									VALUES (NULL,'$rol','$area','$centro','$regional','$cedula','$nombre','$apellido','$telefono','$correo','$clave','$estado')";
